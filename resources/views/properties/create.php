        ...
        <form action="<?= htmlspecialchars(\web_url('/emlak/public/portfoy-kaydet')) ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-3 mb-4">
                <div class="col-12 mb-3">
                    ...
                    <input type="text" name="title" class="form-control form-control-lg text-primary fw-bold" placeholder="Örn: Sahibinden Ankara Manzaralı 3+1 Lüks Daire" required>
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-6 mb-3">
                    ...
                    <select name="category" class="form-select form-select-lg" required>
                        <option value="residential" selected>Konut</option>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="status" class="form-select form-select-lg" required>
                        <option value="for_sale" selected>Satılık Mülk</option>
                        <option value="for_rent">Kiralık Mülk</option>
                    </select>
                </div>
            </div>
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="city" class="form-control" placeholder="Örn; Ankara" required>
                </div>
                <div class="col-md-4 mb-3">
                    <label class="form-label fw-bold">İlçe / Semt *(Zorunlu)</label>
                    <input type="text" name="district" class="form-control" placeholder="Örn; Çankaya" required>
                </div>
                <div class="col-md-4 mb-3">
                    <label class="form-label fw-bold text-success">Fiyat (Türk Lirası) *(Zorunlu)</label>
                    <div class="input-group">
                        <input type="number" step="0.01" name="price" class="form-control fw-bold" placeholder="Örn: 2750000" min="0" required>
            ...
            <div class="row g-3">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="details[rooms]" class="form-control" placeholder="Örn: 3+1">
                </div>
                <div class="col-md-4 mb-3">
                    <label class="form-label">Kesin Metrekare (Net m²)</label>
                    <input type="number" step="1" name="details[net_m2]" class="form-control" placeholder="Örn: 125">
                </div>
                <div class="col-md-4 mb-3">
                    <label class="form-label">Isıtma Seçeneği</label>
                    <input type="text" name="details[heating]" class="form-control" placeholder="Örn: Bireysel Doğalgaz (Kombi)">
                </div>

                <div class="col-md-4 mb-3">
                    <label class="form-label">Bina Yaşı</label>
                    <input type="number" name="details[building_age]" class="form-control" placeholder="Örn: 10">
                </div>
                <div class="col-md-4 mb-3">
                    <label class="form-label">Bulunduğu Kat</label>
                    <input type="text" name="details[floor]" class="form-control" placeholder="Örn: 4. Kat, Ara Kat">
                </div>
                <div class="col-md-4 mb-3">
                    ...
                    <select name="details[furniture]" class="form-select">
                        ...
                        <option value="Yok">Hayır, Eşyasız</option>
                        <option value="Var">Evet, Eşyalı</option>
                    </select>
                </div>
                <div class="col-md-4 mb-3">
             ...
             <div class="row g-3 mb-4">
                <div class="col-md-6 mb-3">
                    ...
                    <select name="key_status" class="form-select">
                        <option value="Bizde" selected>Bizde (Ofiste)</option>     
                        <option value="Mülk Sahibinde">Mülk Sahibinde</option>       
                        <option value="Diğer Emlakçıda">Diğer Emlakçıda (Paslaşma)</option>
                    </select>
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label fw-bold">Anahtar Pano/Kutu Numarası</label>
                    <input type="text" name="key_number" class="form-control" placeholder="Örn: Pano-12, Kutu-A">
            ...
            <div class="row w-100 mb-4 mx-0 mt-5">
                <div class="col-12 p-4 rounded-3 d-flex align-items-center" style="background-color: #e0f2fe; border-left: 5px solid #0d6efd;">
                    ...
                    <div class="form-check form-switch pt-1">
                        <input class="form-check-input" type="checkbox" id="isSharedPool" name="is_shared_pool" style="cursor: pointer; transform: scale(1.5); margin-right: 15px;">
            ...
            <div class="d-flex justify-content-end">
                <button type="submit" class="btn btn-success btn-lg px-5 mx-2 fw-bold shadow-sm">
                    <i class="bi bi-save me-2"></i> İlanı Veritabanına Kaydet
                </button>
            </div>
        </form>
    </div>
